...
//打回重新编目
$('.btnReCategory').click(function () {
	let popBox = $(`<div class="pop" style="padding: 10px;">
		<table class="search-table">
				<tr>
					<td class="lead">内容名称</td>
					<td>${orderRow.managerName}</td>
				</tr><tr>
					<td class="lead"><b class="text-red">*</b>打回到工位</td>
					<td>编目</td>
				</tr><tr>
					<td class="lead" style="vertical-align: top;">打回原因</td>
					<td>
						<textarea name="auditDeny_comment" cols="30" rows="5" maxlength="300"></textarea>
	...
	top.opg.confirm(popBox , function () {
		console.log(popBox.fieldsToJson());
		return true;
	}, {
		title: '重新编目' ,
		width: 480,
